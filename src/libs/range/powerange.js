...
Horizontal.prototype.setMinHTML = function (minHTML) {
  if (minHTML) {
    this.slider.querySelector('.range-min').innerHTML = minHTML
  }
}
Horizontal.prototype.setMaxHTML = function (maxHTML) {
  if (maxHTML) {
    this.slider.querySelector('.range-max').innerHTML = maxHTML
  }
}
